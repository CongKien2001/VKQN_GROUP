        ...
        <div class="main">
            ...
            <div class="content_main">
                ...
                <div class="content_text">
                    <div>
                        Nếu quý khách có nhu cầu đổi trả hàng, vui lòng thông báo ngay cho bộ phận chăm sóc khách hàng của VKQN_GROUP trong vòng 3 ngày kể từ thời điểm nhận hàng thông qua fanpage: https://www.facebook.com/VKQN_GROUP/ . Sau khi nhận được yêu cầu đổi / trả, bộ phận Hỗ trợ khách hàng sẽ phản hồi khách hàng trong vòng 24 giờ làm việc.
                    </div>
                </div>

                <h2 class="content_heading">2. Chính sách đổi trả</h2>
                <div class="content_text">
                    <h3 class="headingVi">VKQN_GROUP không hỗ trợ đổi trả trong các trường hợp sau:</h3>
                    <div class="textVi">
                        <ul>
                    ...
                    <div class="texttext">
                        VKQN_GROUP sẽ xử lý việc đổi trả sản phẩm trong vòng 07 ngày làm việc kể từ ngày nhận được sản phẩm đổi/trả của khách hàng. Đối với trường hợp cần hoàn tiền lại cho khách hàng, VKQN_GROUP sẽ tiến hành xử lý và hoàn tất việc hoàn trả tiền cho khách hàng trong vòng 30 ngày.
                    </div>
                </div>
            </div>
        </div>
