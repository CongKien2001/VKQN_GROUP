<div class="footer_container">
                    ...
                    <div class="footer_info footer_item">
                        ...
                        <ul>
                            <li><a href="./gtVKQN_GROUP/gtVKQN_GROUP.html">Giới thiệu VKQN_GROUP</a></li>
                    ...
                    <div class="footer_support footer_item">
                        ...
                        <ul>
                            <li><a href="/csgh_thanhtoan">Giao hàng và thanh toán</a></li>
                            <li><a href="/csbh">Chính sách bảo hành</a></li>
                            <li><a href="/csdt">Chính sách đổi trả</a></li>
                            <li><a href="/csdh">Hướng dẫn đặt hàng</a></li>
                            <li><a href="/csbanhang">Hướng dẫn bán hàng</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="footer_contact footer_item">
                        ...
                        <ul>
                            <li><i class="fa fa-map-marker"></i> 147D Tân Lập 2 Thủ Đức TPHCM</li>
                            <li><i class="fa fa-phone"></i><a href="tel:0123456789"> 0123 456 789</a></li>
                            <li><i class="fa fa-envelope"></i><a href="mailto:VKQN_GROUP@gmail.com"> VKQN_GROUP@gmail.com</a></li>
