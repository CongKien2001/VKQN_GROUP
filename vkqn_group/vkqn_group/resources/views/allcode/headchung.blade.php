<div class="header">
    <div class="topbar">
        <div class="topbar_place">
            <i class="fas fa-map-marker"></i> TP Thủ Đức
        </div>
        ...
        <div class="header_inner">
            ...
            <div class="header_right" >
                ...
                <div class="header_signin">
                    <a href="{{URL::to('/register')}}"><button class="btn_login js-btn-register" >Đăng Ký</button></a>

                </div>

                <div class="header_login">
                    <a href="{{URL::to('/login')}}"> <button class="btn_login js-btn-login">Đăng Nhập</button></a>
    ...
    <div class="menu">
        ...
        <a href="./dienthoai" id="phone" class="header_home_text">
            <span>ĐIỆN THOẠI</span>
        </a>
        <a href="./laptop" id="laptop" class="header_home_text">
            <span>LAPTOP</span>
        </a>
        <a href="./tablet" id="tablet" class="header_home_text">
            <span>MÁY TÍNH BẢNG</span>
        </a>
        <a href="./phukien" id="phukien" class="header_home_text">
            <span>PHỤ KIỆN</span>
        </a>
        <a href="./contact" id="contact" class="header_home_text">
            <span>LIÊN HỆ</span>
        </a>
    </div>
</div>
