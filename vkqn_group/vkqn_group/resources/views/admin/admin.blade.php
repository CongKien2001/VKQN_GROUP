        ...
        <div class="all">
           @include('allcode.headchungdn')
            ...
            <div class="main">
                    ...
                    @csrf
                        ...
                        <div class="product_item">
                            ...
                            <div class="product_item_info">
                               ...
                               <div class="nutadmin">
                                   <form action="/admin/xoa/{{$product->idProduct}}" method="post">
                                     <input type="submit" class="xoahh" href="" value="Xoá">
                                     @method('DELETE')
                                     @csrf
                                   </form>

                                   <form action="/admin/edit/{{$product->idProduct}}" method="PATCH">
                                        <input type="submit" class="suahh" href="" value="Sửa">
                                        @csrf
                                  </form>
                ...
                <div class="themsp">
                    <a href="{{URL::to('/admin/addsp')}}" class="btnthemsp">☰</a>
                </div>
            </div>
